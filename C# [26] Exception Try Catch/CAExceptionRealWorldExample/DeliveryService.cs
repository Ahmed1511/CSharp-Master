...
namespace CAExceptionRealWorldExample
{
    public class DeliveryService
    {
        ...
        public void Start(Delivery delivery)
        {
            ...
            // Specific Exception.
            catch(AccedentException ex)
            {
                Console.WriteLine($"there was an accedent at {ex.Location} , {ex.Message}");
        ...
        private void Transiant(Delivery delivery)
        {
            ...
            if (r.Next(1, 10) == 1)
            {
                throw new AccedentException("loc 1254", "We have Accedent !!!");
            }
        ...
        private void Delivered(Delivery delivery)
        {
            ...
            if (r.Next(1, 10) == 1)
            {
                throw new InvalidAddressException($"{delivery.Address} is Invalid Address !!!");
            }
